...
<Tabs>
  ...
  <Tab label="Code">
    ...
    {
      "type": "code",
      "file": "./src/registry/preview/radio-group/index.tsx",
      "codeblock": {
        "lang": "tsx"
      }
    }
...
<Tabs>
  <Tab label="CLI">```bash npx @moe/cli add radio-group ```</Tab>
  <Tab label="Manual">
...
### Copy/paste the following code to `@/components/ui/radio-group.tsx`
  ...
  {
    "type": "code",
    "file": "../../packages/registry/src/components/ui/radio-group.tsx",
    "codeblock": {
      "lang": "tsx"
    }
  }
