...
Styled with **NativeWind** (TailwindCSS) — easy theming and dark mode support. Whether you need to tweak a color, adjust spacing, or implement a completely new theme, you can do it directly with utility classes.
