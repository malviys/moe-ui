...
<CliCommand
  ...
  flags={[
    {
      name: "--styling",
      value: "uniwind | nativewind",
      description: "Bypass the interactive styling-engine selection.",
    },
    {
      name: "--yes",
      description: "Accept the non-destructive Uniwind default.",
    },
    {
      name: "--cwd",
      value: "<path>",
      description: "Target a different application package.",
    },
    {
      name: "--package-manager",
      value: "pnpm | npm | yarn | bun",
      description: "Override lockfile detection.",
    },
    {
      name: "--no-install",
      description: "Write configuration without installing dependencies.",
    },
  ]}
/>
  ...
  flags={[
    {
      name: "--cwd",
      value: "<path>",
      description: "Target a different initialized application.",
    },
    {
      name: "--overwrite",
      description: "Replace conflicting component source deliberately.",
    },
    {
      name: "--no-install",
      description: "Write source without installing package dependencies.",
    },
  ]}
/>
