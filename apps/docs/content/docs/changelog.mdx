...
- Interactive Uniwind or NativeWind selection and the `--styling` automation flag.
- NativeWind v5 preview setup for both Next.js and Expo.
...
- NativeWind now uses Tailwind CSS 4, `react-native-css`, CSS-first theme configuration, and the unified `styled` adapter API.
