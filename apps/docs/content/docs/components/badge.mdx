...
```bash
pnpm dlx @moe-ui/cli@beta add badge
```
...
<ComponentPreview name="badge-preview" variant="secondary" />

### Destructive

<ComponentPreview name="badge-preview" variant="destructive" />

### Outline

<ComponentPreview name="badge-preview" variant="outline" />
